...
class SceneClipboard:
    ...
    def serializeSelected(self, delete: bool = False) -> OrderedDict:
        ...
        :type delete: ``bool``
        :return: Serialized data of current selection in NodeEditor :class:`~nodeeditor.node.scene.Scene`
        """
        if DEBUG:
    ...
    def deserializeFromClipboard(self, data: dict):
        ...
        :param data: ``dict`` data for deserialization to the :class:`nodeeditor.node.scene.Scene`.
        :type data: ``dict``
        """
